    ...
    <div className="min-h-screen bg-[url('/assets/one.png')] bg-cover bg-center pt-16">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-white to-yellow-300 bg-clip-text text-transparent mb-6">Contact Us</h1>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="text-white">
              <h2 className="text-3xl md:text-4xl font-bold mb-8 bg-gradient-to-r from-white to-yellow-500 bg-clip-text text-transparent">Get In Touch</h2>
            ...
            <div className=" bg-opacity-10 rounded-lg p-8">
              <form className="space-y-6">
                <div>
                  ...
                  <Input id="name" type="text" className="bg-yellow-200 bg-opacity-90 bg-opacity-90 border-none mt-1" placeholder="Your name" />
                </div>
                <div>
                  <Label htmlFor="email" className="text-white">Email</Label>
                  <Input id="email" type="email" className="bg-yellow-200 bg-opacity-90 border-none mt-1" placeholder="Your email" />
                </div>
                <div>
                  <Label htmlFor="subject" className="text-white">Subject</Label>
                  <Input id="subject" type="text" className="bg-yellow-200 bg-opacity-90 border-none mt-1" placeholder="Subject" />
                </div>
                <div>
                  ...
                  <textarea
                    id="message"
                    rows={5}
                    className="w-full p-3 rounded-md bg-yellow-200 bg-opacity-90 border-none resize-none focus:ring-2 focus:ring-orange-500 focus:outline-none mt-1"
